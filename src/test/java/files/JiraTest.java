...
public class JiraTest {
	...
	String expectedMessage ="Hi How are you?";
		...
		//add comment
	String addCommentResponse = given().pathParam("key", "10005").log().all().header("Content-Type","application/json").body("{\r\n" +
	...
	String commentId= js.getString("id");
		...
		//Add Attachment
		//Adding jira.txt present on project level
		//use multipart() and header as .header("Content-Type","multipart/form-data")
